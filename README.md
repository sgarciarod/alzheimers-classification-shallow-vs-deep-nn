...
El trabajo se realiza en el marco del curso de **Redes Neuronales**, con énfasis en analizar el efecto de la profundidad del modelo sobre el desempeño y la capacidad de generalización.
...
- Diana Barrero Malagón  
- Johan Albarracín Gómez  
...
[Alzheimer’s Disease Dataset - Kaggle](https://www.kaggle.com/datasets/rabieelkharoua/alzheimers-disease-dataset/data)
...
La red neuronal superficial fue entrenada sobre el dataset clínico tabular y evaluada en un conjunto de prueba independiente. Los resultados obtenidos fueron:
...
- Estos resultados posicionan a la **Shallow Neural Network** como una línea base válida para compararla posteriormente con una arquitectura más profunda.
...
- Evaluación de estabilidad y capacidad de generalización del modelo
